...
public class ImprovedLoginBot extends Random {
   ...
   private final solution[] lobbySolutions = {new solution() {
      ...
      public boolean canApply(String message) {
         return interfaces.getComponent(Lobby.INTERFACE_LOBBY, INTERFACE_LOBBY_HIGH_RISK_WORLD_TEXT).getText().toLowerCase().trim().c ontains("high-risk wilderness world");
      }
