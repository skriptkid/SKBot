...
public class GlobalConfiguration {
	...
	public static class Paths {
		...
		public static class URLs {
			private static final String BASE = "http://skbot-client.googlecode.com/svn/updater/v2.3x/";
			public static final String DOWNLOAD = BASE + "SKBot.jar";
			public static final String UPDATE = BASE + "modscript.gz";
			public static final String WEB = BASE + "webwalker.gz";
			public static final String VERSION = BASE + "version.txt";
			public static final String PROJECT = "http://project-skproductions.tk/";
			public static final String SITE = "http://skproductions.tk";
			public static final String SDN_CONTROL = BASE + "sdn-control.txt";
			public static final String AD_INFO = BASE + "ads.txt";
		}
